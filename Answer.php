...
class Answer
{
    ...
    function comscaner()
    {
        ...
        $this->send_reply("sendDocument", $post_params);
    ...
    function save_pdf($update_obj){
        $file_id   = $update_obj->message->document->file_id;
        $file_type = $update_obj->message->document->mime_type;
        if($file_type == "application/pdf") {
            ...
            $this->send_reply("sendMessage", $post_params);
        }
        else {
...
// فکر نمیکنم منظورشون همچین متدی بوده باشه...احتمالا یک متدی که همه چی بفرسته منظورشونه
    ...
    function contect_us()
    {
        ...
        $this->send_reply("sendContact", $post_params);
    }
